		...
		<tr>
			...
			?>
				<tr>
					...
					<td>
						<a class="btn btn-success" href="registration_accept.php?customer_email=<?php echo $array['customer_email'];?>">Accept</a> 
						<a class="btn btn-danger" href="registration_delete.php?customer_email=<?php echo $array['customer_email'];?>">Delete</a>
					</td>
				</tr>
